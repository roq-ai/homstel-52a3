...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['hostel-manager', 'business-owner', 'team-member', 'travel-advisor', 'end-customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Advisors', path: '/advisors', entity: 'advisor', service: AccessServiceEnum.PROJECT, icon: FiHelpCircle },
    {
      name: 'Experiences',
      path: '/experiences',
      entity: 'experience',
    ...
    { name: 'Hostels', path: '/hostels', entity: 'hostel', service: AccessServiceEnum.PROJECT, icon: FiHome },
