  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Homstel - your ultimate hostel and experience aggregator, harnessing the power of AI to revolutionize your trip planning journey."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Homstel - your ultimate hostel and experience aggregator, harnessing the power of AI to revolutionize your trip planning journey.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Hostel Manager" type="hostel-manager" abilities={appConfig.ownerAbilities} />
