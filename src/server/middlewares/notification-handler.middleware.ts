...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create.create': {
    roles: ['business-owner', 'team-member', 'hostel-manager', 'travel-advisor'],
    key: 'bookingId',
    tenantPath: [],
    userPath: [],
  },
...
const ownerRoles: string[] = ['hostel-manager'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['business-owner', 'team-member', 'hostel-manager', 'travel-advisor', 'end-customer'];
